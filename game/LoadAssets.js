// Backgrounds
let bg_trip_full = loadImage({ src : './game/assets/img/bg_trip_full_up.png', maxSeconds : 10 });
...
let bg_windows_98      = loadImage({ src : './game/assets/img/slayer/bg_windows_98.png',      maxSeconds : 10 });
